...
再度C2 Serverにアクセスしたあとに，`botcount`というボットの台数を確認するコマンドを発行し，台数が1と出力されていればボット化の成功です．
...
C2 Serverにアクセスしたあとに，`botcount`というボットの台数を確認するコマンドを発行し，複数台出力されていれば，複数台の感染したボットから構成されるBotnetの構築は完了です．
